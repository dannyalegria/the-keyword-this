//We're in a job interview. Answer the following questions (try to not look at
//your notes unless you have to).
...
//Create an object called user which has the following properties.
  ...
  //username property. *Don't use 'user' instead use the 'this' keyword*
    ...
    //Code Here
var user = {
  username: 'danielalegria',
  email:'danielalegria1217@gmail.com',
...
//increments prius' move property by 10. Returns the new move property.
prius.moveCar();
//increments mustang' move property by 10. Returns the new move property.
mustang.moveCar();

//Hint, you'll need to add a move property and write a moveCar function which is
// added to every object that is being returned from the Car function. You'll
//also need to use the 'this' keyword properly in order to make sure you're
...
//Above you're given an object, and  a function. What will the getUsername
//function return?
//Note(no tests)
  //Answer Here: 'iliketurtles'

//In the example above, what is the 'this keyword' bound to when getUsername
//runs?

  //Answer Here: myUser

//Fix the getMyUsername invocation so that userName will be equal to
//'iliketurtles'.
